# -*- coding: utf-8 -*-
#야구게임파이썬
#문제 : https://github.com/TeamLab/Gachon_CS50_Python_KMOOC/blob/master/lab_assignment/lab_7/READMD.md
...
def is_between_100_and_999(user_input_number):
    ...
    if(int(user_input_number) < 100 or int(user_input_number) > 999) :
        result = False
    else:
        result = True
...
def is_validated_number(user_input_number):
    ...
    if(is_digit(user_input_number)):
        if(is_between_100_and_999(user_input_number)):
            if(is_duplicated_number(int(user_input_number))):
                result = True
            else : result = False
        else : result = False
    else : result = False
...
def get_not_duplicated_three_digit_number():
    ...
    while(True):
        ranNum = get_random_number()
        a = ranNum//100      #100의 자리
        b = ranNum%100//10     # 10의 자리
        c = ranNum%10    #  1의 자리
        if (a==b or b==c or c==a):
            continue
        else:
...
def is_yes(one_more_input):
    ...
    if(one_more_input == "Y" or one_more_input == "y" or one_more_input == "Yes"):
        result = True
    else :
        result = False
...
def is_no(one_more_input):
    ...
    if(one_more_input == "N" or one_more_input == "n" or one_more_input == "No"):
        result = True
    else :
        result = False
